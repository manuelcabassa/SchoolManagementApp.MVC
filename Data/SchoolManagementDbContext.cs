...
public partial class SchoolManagementDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Classes__3214EC07E0E2CAD0");

            entity.HasOne(d => d.Courses).WithMany(p => p.Classes)
                .HasForeignKey(d => d.CoursesId)
                .HasConstraintName("FK__Classes__Courses__4AB81AF0");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Enrollme__3214EC0780BDBA6F");
